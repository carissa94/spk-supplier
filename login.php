            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">SPK Supplier Masakan Bude</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <?php
                        if(isset($_POST["submit"])) :
                            $sql = "SELECT id FROM user WHERE username = '".$_POST['username']."' AND password = md5('".$_POST['password']."')";
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="submit" value="submit">Masuk</button>
                    </div>
                  </form>
                </div>
              </div>
